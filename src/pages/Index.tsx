...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Точение деталей любой сложности на современных токарных станках. Работаем со сталью, алюминием, чугуном.",
    badge: "",
  },
  {
    icon: "Layers",
    title: "Фрезерные работы",
    desc: "Фрезерование плоских и фасонных поверхностей, пазов, зубьев. Высокая точность и чистота обработки.",
    badge: "",
  },
  {
    icon: "CircleDot",
    title: "Расточные работы",
    desc: "Растачивание отверстий, цилиндров и корпусных деталей. Допуски от 0.01 мм.",
    badge: "",
  },
  {
    icon: "Zap",
    title: "Лазерная резка",
    desc: "Резка металла лазером толщиной до 20 мм. Высокая точность реза, минимальные потери материала.",
    badge: "Новинка",
  },
];
...
const STATS = [
  { value: "250+", label: "Выполненных проектов" },
  { value: "10", label: "Лет на рынке" },
  { value: "Краснодарский край", label: "Регион работы" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed max-w-xs">
                Производство и монтаж металлоконструкций любой сложности. Работаем с 2016 года по Краснодарскому краю.
              </p>
            </div>
